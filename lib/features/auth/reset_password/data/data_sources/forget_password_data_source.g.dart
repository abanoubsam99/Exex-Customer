...
class _ForgetPasswordRemoteDataSource
    implements ForgetPasswordRemoteDataSource {
  _ForgetPasswordRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
