...
class _LocationRemoteDataSource implements LocationRemoteDataSource {
  ...
  Future<List<Governate>> getGovernorates() async {
    ...
    final _options = _setStreamType<List<Governate>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/GovernoratesAndCities/GetAllGovernorates',
    ...
    late List<Governate> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => Governate.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<List<City>> getCities(int govId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<City>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/GovernoratesAndCities/${govId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
