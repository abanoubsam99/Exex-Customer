// Apple sign-in — fully prepared but disabled for now (hidden for the store).
// To enable: uncomment this file, add `sign_in_with_apple` to pubspec, enable
// "Sign in with Apple" capability in Xcode, then wire it in LoginCubit + router.
//
