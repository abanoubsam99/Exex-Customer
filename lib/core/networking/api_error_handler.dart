  ...
  switch (error.type) {
    ...
    case DioExceptionType.badResponse:
      if (error.response != null &&
        ...
        //change this if the API returns a different structure
        print(error.response?.data['message'].runtimeType);
        //change this if the API returns a different structure
        return ErrorModel.fromJson(error.response!.data);
      } else if (error.response?.data is String) {
        return ErrorModel(message: error.response!.data);
      } else {
    ...
    case DioExceptionType.unknown:
      if (error.response != null &&
          ...
          error.response?.statusMessage != null) {
        //change this if the API returns a different structure
        return ErrorModel.fromJson(error.response!.data['title']);
      } else {
        return DataSource.DEFAULT.getFailure();
      }
